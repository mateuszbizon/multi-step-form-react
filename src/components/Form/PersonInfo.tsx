  ...
  return (
    <div className="person-info">
      ...
      <div className="person-info__box">
        ...
        <input className={errors.name ? "person-info__input person-info__input--error" : "person-info__input"} id="name" name="name" type="text" {...register("name")} placeholder="e.g. Stephen King" />
      ...
      <div className="person-info__box">
        ...
        <input className={errors.email ? "person-info__input person-info__input--error" : "person-info__input"} id="email" name="email" type="text" {...register("email")} placeholder="e.g. stephenking@lorem.com" />
      ...
      <div className="person-info__box">
        ...
        <input className={errors.phone ? "person-info__input person-info__input--error" : "person-info__input"} id="phone" name="phone" type="text" {...register("phone")} placeholder="e.g. +1 234 567 890" />
